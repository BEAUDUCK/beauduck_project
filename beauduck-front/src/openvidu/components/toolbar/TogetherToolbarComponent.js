...
export default class TogetherToolbarComponent extends Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <div className="toolbar" style={{ height: "5vh" }} >
                    ...
                    <div className="buttonsContent" style={{ textAlign: "center", height: "5vh" }}>
                        {/* 마이크 ON/OFF 아이콘 */}
