  ...
  function onResults(results) {
    ...
    if (results.multiFaceLandmarks) {
      for (const landmarks of results.multiFaceLandmarks) {
        ...
        connect(canvasCtx, landmarks, Facemesh.FACEMESH_RIGHT_EYE, {color: "#FF3030", lineWidth: 2})
        connect(canvasCtx, landmarks, Facemesh.FACEMESH_RIGHT_EYEBROW, {color: "#FF3030", lineWidth: 2})
